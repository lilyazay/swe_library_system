...
class CheckoutHistoriesControllerTest < ActionController::TestCase
  ...
  test "should create checkout_history" do
    assert_difference('CheckoutHistory.count') do
      post :create, checkout_history: { ISBN: @checkout_history.ISBN, checkout_timestamp: @checkout_history.checkout_timestamp, email: @checkout_history.email, return_timestamp: @checkout_history.return_timestamp }
    end
  ...
  test "should update checkout_history" do
    patch :update, id: @checkout_history, checkout_history: { ISBN: @checkout_history.ISBN, checkout_timestamp: @checkout_history.checkout_timestamp, email: @checkout_history.email, return_timestamp: @checkout_history.return_timestamp }
    assert_redirected_to checkout_history_path(assigns(:checkout_history))
  end
