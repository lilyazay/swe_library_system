class AdminsController < ApplicationController
  ...
  def create
    @admin = Admin.new(library_member_params)
  ...
  def destroy
    @admin.destroy
    respond_to do |format|
      format.html { redirect_to library_members_url, notice: 'Admin was successfully destroyed.' }
  ...
  def admin_params
    params.require(:admin).permit(:email, :name, :encrypted_password, :salt)
  end
end
